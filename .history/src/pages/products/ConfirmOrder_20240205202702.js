...
function ConfirmOrder() {
  ...
  const [newAdress,seNewAdress]=useState({
    "country" : "",
    "city" : "",
    "region" : "",
    "street" : "",
  ...
  const addNewAddress = async ()=>{
    try{
      const response = await axios.post('https://ecommerce-1-q7jb.onrender.com/api/v1/user/address/new',{
      country:'',
      city:'',
      region:'',
      street:'',
      zipCode:''
        ...
        console.log('adding new address successfully',response);
      })
    }catch(error){
