...
function ConfirmOrder() {
  ...
  const addNewAddress = async () => {
    try {
      ...
      console.log("error in add newAddress", error.message);
      fetchUserAdresses();
    }
  };
  ...
  return (
    <div className="confirmPage">
      ...
      <Container style={{ marginTop: "50px" }}>
        ...
        <div>
          <button className="useaddress" onClick={()=>setShowForm(!showForm)}>Adding New Address</button>
  {  showForm&&      <Table striped bordered hover size="sm">
            <thead>
              <tr>
                <th className="p-4">country</th>
                <th className="p-4">city</th>
            ...
            <tr>
              <td>
                <input type="text" onChange={(e) => handleInputChange(e, "country")} />
              </td>
              <td>
                <input type="text" onChange={(e) => handleInputChange(e, "city")} />
              </td>
              <td>
                <input type="text" onChange={(e) => handleInputChange(e, "region")} />
              </td>
              <td>
                <input type="text" onChange={(e) => handleInputChange(e, "street")} />
              </td>
              <td>
                <input type="text" onChange={(e) => handleInputChange(e, "zipCode")} />
              </td>
              <td>
                <button className="useaddress" onClick={() => addNewAddress()}>
                  Save this Address
                </button>
              </td>
            </tr>
